...
$(call inherit-product-if-exists, vendor/samsung/kccat6-common/kccat6-common-vendor.mk)
...
# Permissions
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/com.qualcomm.wfd.permissions.xml:system/etc/permissions/com.qualcomm.wfd.permissions.xml\
